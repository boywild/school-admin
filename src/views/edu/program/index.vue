  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            ...
            <template v-if="advanced">
              ...
              <a-col :md="8" :sm="24">
                <a-form-item label="负责人">
                  <a-input v-model="queryParam.principalGuy" placeholder="请输负责人" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col :md="8" :sm="24">
                <a-form-item label="学校负责老师">
                  <a-input v-model="queryParam.dutyTeacher" placeholder="请输入学校负责老师" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col :md="8" :sm="24">
            ...
            <a-col :md="(!advanced && 8) || 24" :sm="24" v-if="$auth('T032')">
              <span
      ...
      <div class="table-operator">
        <a-button type="primary" icon="plus" v-action:T033 @click="handleAdd">新建</a-button>
        <a-button type="danger" icon="delete" v-action:T034 @click="deleteStudent">删除</a-button>
        <a-button type="primary" ghost icon="download" v-action:T035 @click="downLoad">导出数据</a-button>
        <a-button type="primary" ghost icon="upload" v-action:T035 @click="importExcel">导入数据</a-button>
      </div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <template>
            ...
            <a-divider v-action:T037 type="vertical" />
            <a v-action:T037 @click="handleModify(record, 'ImgInfo')">图片</a>
            <a-divider v-action:T038 type="vertical" />
            <a v-action:T038 @click="handleModify(record, 'JoinInfo')">报名</a>
            <a-divider v-action:T039 type="vertical" />
            <a v-action:T039 @click="handleModify(record, 'EduTask')">教务</a>
            <a-divider v-action:T040 type="vertical" />
            <a v-action:T040 @click="handleModify(record, 'StudyCost')">财务</a>
          </template>
        </span>
      </s-table>
...
export default {
  ...
  methods: {
    ...
    importExcel() {
      this.$router.push({ name: 'sysImport', query: { applyType: 'S004' } })
    }
  }
}
</script>
