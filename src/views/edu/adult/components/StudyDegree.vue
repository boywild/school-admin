  ...
  data() {
    ...
    return {
      ...
      tab5: [
        ...
        { label: '专业', field: 'major', form: 'input', rules: [{ max: '10', message: '专业制输入10位' }] },
        { label: '学制', field: 'duration', form: 'input', rules: [{ max: '10', message: '学制限制输入10位' }] },
        ...
        // },
        // { label: '电话', field: 'xxxx', form: 'input', rules: [{ max: '11', message: '电话限制输入11位' }] },
        { label: '学号', field: 'studentNo', form: 'input', rules: [{ max: '20', message: '学号限制输入20位' }] },
        {
          label: '学位性质',
