...
// 学位性质
export const DEGREE_ENMU = [
  { desc: '高校联盟', code: '0' },
  { desc: '本校学位', code: '1' },
  { desc: '免考', code: '2' }
]
export const DEGREELEVEL_ENMU = [
  { desc: '专科', code: '0' },
  { desc: '本科', code: '1' }
]

// 毕业论文
export const THESIS_FROM_ENMU = [
  { desc: '学历论文', code: '0' },
  { desc: '非学历论文', code: '1' }
]

// 学位分数
export const REACH_ENMU = [
  { desc: '及格', code: '0' },
  { desc: '不及格', code: '1' }
]
